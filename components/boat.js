...
const Boat = () => {
    return (
        <div className = {boat()}>
            <svg stroke-miterlimit="10" style={{fillRule:"nonzero",clipRule:"evenodd",strokeLinecap:"round",strokeLinejoin:"round"}} viewBox="0 0 554 950" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            <defs>
            ...
            <g clip-path="url(#a)">
                ...
                <use fill="none" mask="url(#c)" stroke={DARKEST} stroke-linecap="butt" stroke-linejoin="miter" stroke-width="9.1" xlinkHref="#b"/>
                ...
                <use fill="#fff" fill-rule="evenodd" xlinkHref="#d"/>
                </mask>
                <use fill="none" mask="url(#e)" stroke={DARKEST} stroke-linecap="butt" stroke-linejoin="miter" stroke-width="9.1" xlinkHref="#d"/>
                ...
                <use fill="#fff" fill-rule="evenodd" xlinkHref="#f"/>
                </mask>
                <use fill="none" mask="url(#g)" stroke={DARKEST} stroke-linecap="butt" stroke-linejoin="miter" stroke-width="9.1" xlinkHref="#f"/>
                ...
                <use fill="#fff" fill-rule="evenodd" xlinkHref="#h"/>
                </mask>
                <use fill="none" mask="url(#i)" stroke={DARKEST} stroke-linecap="butt" stroke-linejoin="miter" stroke-width="9.1" xlinkHref="#h"/>
                <g className={boatStyle.boat}>
                    <path d="M126.5 700.5s-20.8 29.5-20.4 46.8c.2 6.8 18.8 106 18.8 106l57-9s-15.6-95.7-20.1-107.7c-5.4-14.3-35.3-36-35.3-36Z" fill={BACKGROUND} stroke={DARKEST} stroke-linecap="butt" stroke-width="4.6"/>
                    <path d="m122.6 725 16-3.1s10.4 6.7 15 19.9c4.8 13.1 7.4 33 7.4 33l-40.5 7.5s-4.6-21-5-35c-.5-13.8 7.1-22.3 7.1-22.3Z" fill={DARKACCENT} stroke={DARKEST} stroke-linecap="butt" stroke-width="4.6"/>
                    <path className={boatStyle.move} d="m122 791.3 41.4-7.9 5.6 33.5-40.7 7.4-6.4-33Z" fill={DARKACCENT} stroke={DARKEST} stroke-linecap="butt" stroke-width="4.1"/>
                    <path className={boatStyle.lines} d="M134 889.3s11-19.9 24.2-20.6a47.5 47.5 0 0 1 26.5 9.2M129.2 916.5s13.6-22.7 29.8-23.8c16.2-1 42.3 10 42.3 10M139 868.4s7.2-5.5 14.4-7.5 19.2 1.7 19.2 1.7M162.2 719.3s7.8 5.8 10.3 18.3a208 208 0 0 1 3.4 22.6M97.7 724.5s-6.3 10.5-6.9 24.8c-.5 14.4 4.7 32.6 4.7 32.6" fill="none" stroke={DARKER} stroke-width="4.1"/>
                </g>     
            </g>
            </svg>
        </div>
