...
const Boat = ({toggle}) => {
    return (
        <svg width="180" preserveAspectRatio="xMidYMin slice" strokeMiterlimit="10" style={{fillRule:"nonzero",clipRule:"evenodd",strokeLinecap:"round",strokeLinejoin:"round"}} viewBox="0 0 554 950" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            <defs>
